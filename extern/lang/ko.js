...
Lang.AiLearning = {
    ...
    train_param_gainThreshold: '가지분기 기준값',
    max_depth_error: '트리의 최대 깊이는 2 이상으로 입력해 주세요.',
    min_samples_error: '노드의 최소 데이터 수는 전체 학습 데이터 수(%d)보다 작거나 같아야 합니다.',
    min_samples_error_under: '노드의 최소 데이터 수는 2 이상으로 입력해 주세요.',
    learning_rate_error: '학습률은 0보다 큰 값으로 입력해 주세요.',
    epochs_error: '학습 횟수는 1 이상의 정수로 입력해 주세요.',
    validation_rate_error: '검증 데이터 비율은 0.1 ~ 0.9 사이의 값으로 입력해 주세요.',
    k_cluster_error: '군집 개수는 1 이상의 정수로 입력해 주세요.',
    svm_c_error: 'C 값은 0보다 큰 값으로 입력해 주세요.',
    svm_degree_error: '차수는 1 이상의 정수로 입력해 주세요.',
