...
Entry.Hamster.setLanguage = () => ({
    ...
    uz: {
        ...
        Blocks: {
            hamster_note_c: 'Do',
            hamster_note_c_sharp: 'Do♯(Re♭)',
            hamster_note_d: 'Re',
            hamster_note_d_sharp: 'Re♯(Mi♭)',
            hamster_note_e: 'Mi',
            hamster_note_f: 'Fa',
            hamster_note_f_sharp: 'Fa♯(Sol♭)',
            hamster_note_g: 'Sol',
            hamster_note_g_sharp: 'Sol♯(Lya♭)',
            hamster_note_a: 'Lya',
            hamster_note_a_sharp: 'Lya♯(Si♭)',
            hamster_note_b: 'Si',
            hamster_tilt_forward: 'Oldinga egilgan',
            hamster_tilt_backward: 'Orqaga egilgan',
            hamster_tilt_left: 'Chapga egilgan',
            hamster_tilt_right: "O'ngga egilgan",
            hamster_tilt_flip: "To'nkarilgan",
            hamster_tilt_not: 'Egailmagan',
            hamster_battery_normal: 'Batareya odatda',
            hamster_battery_low: 'Batareya kam',
            hamster_battery_empty: "Batareya yo'q",
            hamster_open_gripper: 'Ochiq',
            hamster_close_gripper: 'Yopiq',
        },
    },
});
